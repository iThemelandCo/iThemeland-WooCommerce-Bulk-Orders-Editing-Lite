...
class WOBEF_Post
{
                ...
                if (!empty($_POST['email']) && !empty($_POST['industry'])) {
                    ...
                    if (!empty($info) && is_array($info)) {
                        if (!empty($info['result']) && $info['result'] == true) {
                            ...
                            $message = (!empty($info['message'])) ? esc_html($info['message']) : esc_html__('System Error !', WOBEF_NAME);
                        }
                    } else {
                        update_option('wobef_is_active', 'no');
                        $message = esc_html__('Connection Timeout! Please Try Again', WOBEF_NAME);
                    }
                }
            }
        }
    ...
    public function meta_fields()
    {
        ...
        $this->redirect('meta-fields', esc_html__('Success !', WOBEF_NAME));
    }
    ...
    public function column_manager_new_preset()
    {
        ...
        $this->redirect('column-manager', esc_html__('Success !', WOBEF_NAME));
    }
    ...
    public function settings()
    {
        ...
        $this->redirect('settings', esc_html__('Success !', WOBEF_NAME));
    }
    ...
    public function import_orders()
    {
        ...
        $this->redirect('import-export', esc_html__($message, WOBEF_NAME));
    }
