...
class Order
{
    ...
    public function get_orders_list($data, $active_page)
    {
        ...
        $after_dynamic_columns = [
            [
                'title' => esc_html__('Actions', WOBEF_NAME),
                'field' => 'action',
            ]
        ];
    ...
    public function get_order_statuses()
    {
        ...
        $statuses['trash'] = esc_html__('Trash', WOBEF_NAME);
    ...
    public function order_to_array($order_object)
    {
        ...
        return [
            ...
            'post_date' => (!empty($order_object->get_date_created()) && !empty($order_object->get_date_created()->date('Y/m/d H:i'))) ? $order_object->get_date_created()->format('Y/m/d H:i') : '',
            'post_modified' => (!empty($order_object->get_date_modified()) && !empty($order_object->get_date_modified()->date('Y/m/d H:i'))) ? $order_object->get_date_modified()->format('Y/m/d H:i') : '',
            ...
            '_customer_ip_address' => $order_object->get_customer_ip_address(),
            '_customer_user' => ($customer_name instanceof \WP_User) ? $customer_name->user_nicename : '',
            '_customer_user_id' => $order_object->get_customer_id(),
            '_customer_user_agent' => ($customer_agent_name instanceof \WP_User) ? $customer_agent_name->user_nicename : '',
            '_paid_date' => $order_object->get_date_paid(),
            '_completed_date' => $order_object->get_date_completed(),
            '_order_total' => $order_object->get_total(),
            '_order_sub_total' => $order_object->get_subtotal(),
            '_cart_discount' => $order_object->get_total_discount(),
            '_cart_discount_tax' => $order_object->get_discount_tax(),
            '_created_via' => $order_object->get_created_via(),
            '_order_currency' => $order_object->get_currency(),
            '_shipping_method' => $order_object->get_shipping_method(),
            '_payment_method' => $order_object->get_payment_method(),
            '_payment_method_title' => $order_object->get_payment_method_title(),
            '_order_version' => $order_object->get_version(),
            '_prices_include_tax' => $order_object->get_prices_include_tax(),
            '_order_tax' => (isset($post_meta['_order_tax'][0])) ? $post_meta['_order_tax'][0] : '',
            '_order_shipping' => $order_object->get_shipping_total(),
            '_order_shipping_tax' => $order_object->get_shipping_tax(),
            '_billing_address_1' => $order_object->get_billing_address_1(),
            '_billing_address_2' => $order_object->get_billing_address_2(),
            '_billing_city' => $order_object->get_billing_city(),
            '_billing_company' => $order_object->get_billing_company(),
            '_billing_country' => $order_object->get_billing_country(),
            '_billing_email' => $order_object->get_billing_email(),
            '_billing_phone' => $order_object->get_billing_phone(),
            '_billing_first_name' => $order_object->get_billing_first_name(),
            '_billing_last_name' => $order_object->get_billing_last_name(),
            '_billing_address_index' => $order_object->get_formatted_billing_address(),
            '_billing_postcode' => $order_object->get_billing_postcode(),
            '_billing_state' => $order_object->get_billing_state(),
            '_transaction_id' => $order_object->get_transaction_id(),
            '_shipping_address_1' => $order_object->get_shipping_address_1(),
            '_shipping_address_2' => $order_object->get_shipping_address_2(),
            '_shipping_address_index' => $order_object->get_formatted_shipping_address(),
            '_shipping_city' => $order_object->get_shipping_city(),
            '_shipping_company' => $order_object->get_shipping_company(),
            '_shipping_country' => $order_object->get_shipping_country(),
            '_shipping_first_name' => $order_object->get_shipping_first_name(),
            '_shipping_last_name' => $order_object->get_shipping_last_name(),
            '_shipping_postcode' => $order_object->get_shipping_postcode(),
            '_shipping_state' => $order_object->get_shipping_state(),
    ...
    public function order_to_array_for_export($order_object)
    {
        ...
        return [
            'id' => $order_object->get_id(),
            'post_date' => $order_object->get_date_created(),
            'customer_note' => $order_object->get_customer_note(),
            'post_status' => $order_status,
            ...
            '_recorded_sales' => (!empty($post_meta['_recorded_sales'][0]) && $post_meta['_recorded_sales'][0] == 'yes') ? 'yes' : 'no',
            '_customer_ip_address' => $order_object->get_customer_ip_address(),
            '_customer_user' => $order_object->get_customer_id(),
            '_customer_user_agent' => ($customer_agent_name instanceof \WP_User) ? $customer_agent_name->user_nicename : '',
            '_paid_date' => $order_object->get_date_paid(),
            '_completed_date' => $order_object->get_date_completed(),
            '_order_total' => $order_object->get_total(),
