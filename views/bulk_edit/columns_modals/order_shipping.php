        ...
        <div class="wobef-modal-box wobef-modal-box-sm">
            <div class="wobef-modal-content">
                <div class="wobef-modal-title">
                    <h2><?php esc_html_e('Order', WOBEF_NAME); ?> <span id="wobef-modal-order-shipping-item-title" class="wobef-modal-item-title"></span></h2>
                ...
                <div class="wobef-modal-body">
                    <div class="wobef-wrap">
                        <div class="wobef-col-full wobef-mb20">
                            <h3><?php esc_html_e('Shipping', WOBEF_NAME); ?></h3>
                            <a href="javascript:;" class="wobef-modal-load-shipping-address" data-target="#wobef-modal-order-shipping" data-order-field="customer-user-id" data-customer-id=""><?php esc_html_e('Load shipping address', WOBEF_NAME); ?></a>
                            <span> | </span>
                            <a href="javascript:;" href="javascript:;" class="wobef-modal-load-billing-address" data-target="#wobef-modal-order-shipping" data-order-field="customer-user-id" data-customer-id=""><?php esc_html_e('Copy billing address', WOBEF_NAME); ?></a>
                        </div>
                        <div class="wobef-col-half">
                            <div class="wobef-mb10">
                                <label for="order-shipping-modal-first-name"><?php esc_html_e('First Name', WOBEF_NAME); ?></label>
                                <input type="text" id="order-shipping-modal-first-name" data-order-field="first-name">
                            </div>
                            <div class="wobef-mb10">
                                <label for="order-shipping-modal-address-1"><?php esc_html_e('Address 1', WOBEF_NAME); ?></label>
                                <input type="text" id="order-shipping-modal-address-1" data-order-field="address-1">
                            </div>
                            <div class="wobef-mb10">
                                <label for="order-shipping-modal-city"><?php esc_html_e('City', WOBEF_NAME); ?></label>
                                <input type="text" id="order-shipping-modal-city" data-order-field="city">
                            </div>
                            <div class="wobef-mb10">
                                <label for="order-shipping-modal-country"><?php esc_html_e('Country', WOBEF_NAME); ?></label>
                        ...
                        <div class="wobef-col-half">
                            <div class="wobef-mb10">
                                <label for="order-shipping-modal-last-name"><?php esc_html_e('Last Name', WOBEF_NAME); ?></label>
                                <input type="text" id="order-shipping-modal-last-name" data-order-field="last-name">
                            </div>
                            <div class="wobef-mb10">
                                <label for="order-shipping-modal-address-2"><?php esc_html_e('Address 2', WOBEF_NAME); ?></label>
                                <input type="text" id="order-shipping-modal-address-2" data-order-field="address-2">
                            </div>
                            <div class="wobef-mb10">
                                <label for="wobef-modal-order-shipping-state"><?php esc_html_e('State', WOBEF_NAME); ?></label>
                                <select id="wobef-modal-order-shipping-state" data-order-field="state">
                                    <option value=""><?php esc_html_e('Select', WOBEF_NAME); ?></option>
                                </select>
                            </div>
                            <div class="wobef-mb10">
                                <label for="order-shipping-modal-postcode"><?php esc_html_e('Postcode', WOBEF_NAME); ?></label>
                                <input type="text" id="order-shipping-modal-postcode" data-order-field="postcode">
                            </div>
                        </div>
                        <div class="wobef-col-full wobef-mb20">
                            <div class="wobef-mb10">
                                <label for="order-shipping-modal-company"><?php esc_html_e('Company', WOBEF_NAME); ?></label>
                                <input type="text" id="order-shipping-modal-company" data-order-field="company">
                            </div>
                            <div class="wobef-mb10">
                                <label for="order-shipping-modal-customer-note"><?php esc_html_e('Customer Note', WOBEF_NAME); ?></label>
