<div class="wobef-wrap">
    <div class="wobef-tab-middle-content">
        <div class="wobef-alert wobef-alert-default">
            <span><?php esc_html_e('You can add new orders meta fields in two ways: 1- Individually 2- Get from other order.', WOBEF_NAME); ?></span>
        </div>
        ...
        <div class="wobef-meta-fields-left">
            <div class="wobef-meta-fields-manual">
                <label for="wobef-meta-fields-manual_key_name"><?php esc_html_e('Manually', WOBEF_NAME); ?></label>
                <div class="wobef-meta-fields-manual-field">
                    <input type="text" id="wobef-meta-fields-manual_key_name" placeholder="<?php esc_html_e('Enter Meta Key ...', WOBEF_NAME); ?>">
            ...
            <div class="wobef-meta-fields-automatic">
                <label for="wobef-add-meta-fields-order-id"><?php esc_html_e('Automatically From Order', WOBEF_NAME); ?></label>
                <div class="wobef-meta-fields-automatic-field">
                    <input type="text" id="wobef-add-meta-fields-order-id" placeholder="<?php esc_html_e('Enter Order ID ...', WOBEF_NAME); ?>">
        ...
        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
            ...
            <div class="wobef-meta-fields-right" id="wobef-meta-fields-items">
                <p class="wobef-meta-fields-empty-text" <?php echo (!empty($meta_fields)) ? 'style="display:none";' : ''; ?>><?php esc_html_e("Please add your meta key manually", WOBEF_NAME); ?><br> <?php esc_html_e("OR", WOBEF_NAME); ?><br><?php esc_html_e("From another order", WOBEF_NAME); ?></p>
            ...
            <div class="wobef-meta-fields-buttons">
                <div class="wobef-meta-fields-buttons-left">
                    <button type="submit" value="1" name="save_meta_fields" class="wobef-button wobef-button-lg wobef-button-blue">
                        ...
                        <span><?php esc_html_e('Save Fields', WOBEF_NAME); ?></span>
                    </button>
                </div>
            </div>
        </form>
