                ...
                <div class="wobef-wrap">
                    <div class="wobef-tab-middle-content">
                        <div id="wobef-activation-info">
                            <strong><?php esc_html_e("Congratulations, Your plugin is activated successfully. Let's Go!", WOBEF_NAME) ?></strong>
                        </div>
                    </div>
                </div>
            <?php else : ?>
                    ...
                    <div class="wobef-tab-middle-content">
                        ...
                        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" id="wobef-activation-form">
                            ...
                            <div class="wobef-activation-field">
                                <label for="wobef-activation-email"><?php esc_html_e('Email', WOBEF_NAME); ?> </label>
                                <input type="email" name="email" placeholder="Email ..." id="wobef-activation-email">
                            </div>
                            <div class="wobef-activation-field">
                                <label for="wobef-activation-industry"><?php esc_html_e('What is your industry?', WOBEF_NAME); ?> </label>
                            ...
                            <button type="button" id="wobef-activation-activate" class="wobef-button wobef-button-lg wobef-button-blue" value="1"><?php esc_html_e('Activate', WOBEF_NAME); ?></button>
                            <button type="button" id="wobef-activation-skip" class="wobef-button wobef-button-lg wobef-button-gray" style="float: left;" value="skip"><?php esc_html_e('Skip', WOBEF_NAME); ?></button>
                        </form>
                    </div>
                </div>
            <?php endif; ?>
