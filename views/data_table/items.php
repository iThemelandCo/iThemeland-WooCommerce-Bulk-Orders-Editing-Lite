<table id="wobef-items-list">
        ...
        <tr>
            <?php if (isset($show_id_column) && $show_id_column === true) : ?>
                ...
                <th class="wobef-td70 <?php echo ($sticky_first_columns == 'yes') ? 'wobef-td-sticky wobef-td-sticky-id' : ''; ?>">
                    <input type="checkbox" class="wobef-check-item-main" title="<?php esc_html_e('Select All', WOBEF_NAME); ?>">
                    <label data-column-name="id" class="wobef-sortable-column"><?php esc_html_e('ID', WOBEF_NAME); ?><span class="wobef-sortable-column-icon"><?php echo sprintf('%s', $sortable_icon); ?></span></span>
                </th>
            <?php endif; ?>
    ...
    <tbody>
        <?php if (!empty($items_loading)) : ?>
            <tr>
                <td colspan="8" class="wobef-text-alert"><?php esc_html_e('Loading ...', WOBEF_NAME); ?></td>
            </tr>
        ...
        <?php else : ?>
            <tr>
                <td colspan="8" class="wobef-text-alert"><?php esc_html_e('No Data Available!', WOBEF_NAME); ?></td>
            </tr>
        <?php endif; ?>
    </tbody>
    <tfoot>
