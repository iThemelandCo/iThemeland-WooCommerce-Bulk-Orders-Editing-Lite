<div class="wobef-wrap">
    <div class="wobef-tab-middle-content">
        <div class="wobef-alert wobef-alert-default">
            <span><?php esc_html_e('List of your changes and possible to roll back to the previous data', WOBEF_NAME); ?></span>
        </div>
        ...
        <div class="wobef-history-filter">
            <div class="wobef-history-filter-fields">
                <div class="wobef-history-filter-field-item">
                    <label for="wobef-history-filter-operation"><?php esc_html_e('Operation', WOBEF_NAME); ?></label>
                ...
                <div class="wobef-history-filter-field-item">
                    <label for="wobef-history-filter-author"><?php esc_html_e('Author', WOBEF_NAME); ?></label>
                ...
                <div class="wobef-history-filter-field-item">
                    <label for="wobef-history-filter-fields"><?php esc_html_e('Fields', WOBEF_NAME); ?></label>
                ...
                <div class="wobef-history-filter-field-item wobef-history-filter-field-date">
                    <label><?php esc_html_e('Date', WOBEF_NAME); ?></label>
                    <input type="text" id="wobef-history-filter-date-from" class="wobef-datepicker wobef-date-from" data-to-id="wobef-history-filter-date-to" placeholder="<?php esc_html_e('From ...', WOBEF_NAME); ?>">
                    <input type="text" id="wobef-history-filter-date-to" class="wobef-datepicker" placeholder="<?php esc_html_e('To ...', WOBEF_NAME); ?>">
                </div>
            </div>
            <div class="wobef-history-filter-buttons">
                <div class="wobef-history-filter-buttons-left">
                    <button type="button" class="wobef-button wobef-button-lg wobef-button-blue" disabled="disabled">
                        ...
                        <span><?php esc_html_e('Apply Filters', WOBEF_NAME); ?></span>
                    </button>
                    <button type="button" class="wobef-button wobef-button-lg wobef-button-gray" disabled="disabled">
                        <i class="lni lni-spinner-arrow"></i>
                        <span><?php esc_html_e('Reset Filters', WOBEF_NAME); ?></span>
                    </button>
                </div>
                <div class="wobef-history-filter-buttons-right">
                    <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" id="wobef-history-clear-all">
                        ...
                        <button type="button" name="clear_all" value="1" disabled="disabled" class="wobef-button wobef-button-lg wobef-button-red">
                            ...
                            <span><?php esc_html_e('Clear History', WOBEF_NAME); ?></span>
                        </button>
                    </form>
                </div>
            </div>
        ...
        <div class="wobef-history-items">
            <h3><?php esc_html_e('Column(s)', WOBEF_NAME); ?></h3>
            <div class="wobef-table-border-radius">
                <table>
                    <thead>
                        <tr>
                            <th>#</th>
                            <th><?php esc_html_e('History Name', WOBEF_NAME); ?></th>
                            <th><?php esc_html_e('Author', WOBEF_NAME); ?></th>
                            <th class="wobef-mw125"><?php esc_html_e('Date Modified', WOBEF_NAME); ?></th>
                            <th class="wobef-mw250"><?php esc_html_e('Actions', WOBEF_NAME); ?></th>
                        </tr>
                    </thead>
                    <tbody>
