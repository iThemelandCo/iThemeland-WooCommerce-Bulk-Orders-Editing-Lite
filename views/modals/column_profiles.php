        ...
        <div class="wobef-modal-box wobef-modal-box-lg">
            <div class="wobef-modal-content">
                <div class="wobef-modal-title">
                    <h2><?php esc_html_e('Column Profiles', WOBEF_NAME); ?></h2>
                ...
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                    ...
                    <div class="wobef-modal-body">
                        <div class="wobef-wrap">
                            <div class="wobef-alert wobef-alert-default">
                                <span><?php esc_html_e('You can load saved column profile presets through Column Manager. You can change the columns and save your changes too.', WOBEF_NAME); ?></span>
                            </div>
                            <div class="wobef-column-profiles-choose">
                                <label for="wobef-column-profiles-choose"><?php esc_html_e('Choose Preset', WOBEF_NAME); ?></label>
                                                        ...
                                                        <div class="wobef-column-profile-fields-group">
                                                            ...
                                                            <ul>
                                                                <?php foreach ($column_fields as $name => $column_field) : ?>
                                                                    ...
                                                                    <li>
                                                                        <label>
                                                                            <input type="checkbox" name="columns_<?php echo esc_attr($column_manager_preset['key']); ?>[]" value="<?php echo esc_attr($name); ?>" <?php echo $selected; ?>>
                    ...
                    <div class="wobef-modal-footer">
                        <button type="submit" class="wobef-button wobef-button-blue wobef-float-left" id="wobef-column-profiles-apply" data-preset-key="<?php echo (!empty($first_key)) ? $first_key : ''; ?>">
                            <?php esc_html_e('Apply To Table', WOBEF_NAME); ?>
                        </button>
                        <div class="wobef-column-profile-search wobef-float-right">
                            <label for="wobef-column-profile-search"><?php esc_html_e('Search', WOBEF_NAME); ?> </label>
                            <input type="text" id="wobef-column-profile-search" placeholder="<?php esc_html_e('Search Column ...', WOBEF_NAME); ?>">
                        </div>
                    </div>
                </form>
            </div>
