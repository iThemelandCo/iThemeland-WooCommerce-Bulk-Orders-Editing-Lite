jQuery(document).ready(function ($) {
    ...
    $(document).on("keypress", "[data-type=edit-mode]", function (event) {
        ...
        if (wobefKeyCode === 13) {
            ...
            let wobefValue = $(this).val();
            $(this).closest("span").html($(this).val());
            wobefInlineEdit(OrderIds, wobefField, wobefValue, reload_orders);
        }
    });
    ...
    $(document).on("click", ".wobef-inline-edit-clear-date", function () {
        ...
        wobefInlineEdit(OrderIds, wobefField, '', reload_orders);
    });
    ...
    $(document).on("click", ".wobef-edit-action-price-calculator", function () {
        ...
        let wobefField = $(this).attr("data-field");
        let values = {
            operator: $("#wobef-" + wobefField + "-calculator-operator-" + orderID).val(),
            value: $("#wobef-" + wobefField + "-calculator-value-" + orderID).val(),
            operator_type: $("#wobef-" + wobefField + "-calculator-type-" + orderID).val(),
            roundItem: $("#wobef-" + wobefField + "-calculator-round-" + orderID).val()
        };
    ...
    // Quick Per Page
    $("#wobef-quick-per-page").on("change", function () {
    ...
    $(document).on("click", ".wobef-edit-action-with-button", function () {
        ...
        switch ($(this).attr("data-content-type")) {
            ...
            case "image":
                ...
                break;
            case "gallery":
                wobefValue = $("div[data-gallery-id=wobef-gallery-items-" + $(this).attr("data-item-id") + "] input.wobef-inline-edit-gallery-image-ids").map(function () {
                    return $(this).val();
                }).get();
                break;
        }
    ...
    $(document).on("click", "#wobef-bulk-edit-form-do-bulk-edit", function (e) {
        ...
        let ordersChecked = $("input.wobef-check-item:checkbox:checked");
        let custom_fields = [];
        $(".wobef-tab-content-item[data-content=custom_fields] .wobef-form-group").each(function () {
            let item = $(this);
        ...
        let data = {
            post_date: {
                value: $("#wobef-bulk-edit-form-order-created-date").val()
            },
            _paid_date: {
                value: $("#wobef-bulk-edit-form-order-paid-date").val()
            },
            post_status: {
                value: $("#wobef-bulk-edit-form-order-status").val()
            },
            customer_note: {
                value: $("#wobef-bulk-edit-form-customer-note").val()
            },
            order_notes: {
                operator: $("#wobef-bulk-edit-form-order-notes-operator").val(),
                value: $("#wobef-bulk-edit-form-order-notes").val()
            },
            _billing_address_1: {
                value: $("#wobef-bulk-edit-form-order-billing-address-1").val(),
                replace: $("#wobef-bulk-edit-form-order-billing-address-1-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-billing-address-1-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-billing-address-1-operator").val()
            },
            _billing_address_2: {
                value: $("#wobef-bulk-edit-form-order-billing-address-2").val(),
                replace: $("#wobef-bulk-edit-form-order-billing-address-2-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-billing-address-2-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-billing-address-2-operator").val()
            },
            _billing_city: {
                value: $("#wobef-bulk-edit-form-order-billing-city").val(),
                replace: $("#wobef-bulk-edit-form-order-billing-city-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-billing-city-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-billing-city-operator").val()
            },
            _billing_country: {
                value: $("#wobef-bulk-edit-form-order-billing-country").val()
            },
            _billing_company: {
                value: $("#wobef-bulk-edit-form-order-billing-company").val()
            },
            _billing_state: {
                value: ($("select.wobef-bulk-edit-form-order-billing-state").val()) ? $("select.wobef-bulk-edit-form-order-billing-state").val() : $("input.wobef-bulk-edit-form-order-billing-state").val()
            },
            _billing_phone: {
                value: $("#wobef-bulk-edit-form-order-billing-phone").val(),
                replace: $("#wobef-bulk-edit-form-order-billing-phone-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-billing-phone-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-billing-phone-operator").val()
            },
            _billing_email: {
                value: $("#wobef-bulk-edit-form-order-billing-email").val(),
                replace: $("#wobef-bulk-edit-form-order-billing-email-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-billing-email-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-billing-email-operator").val()
            },
            _billing_first_name: {
                value: $("#wobef-bulk-edit-form-order-billing-first-name").val(),
                replace: $("#wobef-bulk-edit-form-order-billing-first-name-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-billing-first-name-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-billing-first-name-operator").val()
            },
            _billing_last_name: {
                value: $("#wobef-bulk-edit-form-order-billing-last-name").val(),
                replace: $("#wobef-bulk-edit-form-order-billing-last-name-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-billing-last-name-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-billing-last-name-operator").val()
            },
            _billing_postcode: {
                value: $("#wobef-bulk-edit-form-order-billing-postcode").val(),
                replace: $("#wobef-bulk-edit-form-order-billing-postcode-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-billing-postcode-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-billing-postcode-operator").val()
            },
            _shipping_address_1: {
                value: $("#wobef-bulk-edit-form-order-shipping-address-1").val(),
                replace: $("#wobef-bulk-edit-form-order-shipping-address-1-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-shipping-address-1-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-shipping-address-1-operator").val()
            },
            _shipping_address_2: {
                value: $("#wobef-bulk-edit-form-order-shipping-address-2").val(),
                replace: $("#wobef-bulk-edit-form-order-shipping-address-2-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-shipping-address-2-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-shipping-address-2-operator").val()
            },
            _shipping_city: {
                value: $("#wobef-bulk-edit-form-order-shipping-city").val(),
                replace: $("#wobef-bulk-edit-form-order-shipping-city-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-shipping-city-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-shipping-city-operator").val()
            },
            _shipping_country: {
                value: $("#wobef-bulk-edit-form-order-shipping-country").val()
            },
            _shipping_state: {
                value: ($("select.wobef-bulk-edit-form-order-shipping-state").val()) ? $("select.wobef-bulk-edit-form-order-shipping-state").val() : $("input.wobef-bulk-edit-form-order-shipping-state").val()
            },
            _shipping_first_name: {
                value: $("#wobef-bulk-edit-form-order-shipping-first-name").val(),
                replace: $("#wobef-bulk-edit-form-order-shipping-first-name-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-shipping-first-name-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-shipping-first-name-operator").val()
            },
            _shipping_last_name: {
                value: $("#wobef-bulk-edit-form-order-shipping-last-name").val(),
                replace: $("#wobef-bulk-edit-form-order-shipping-last-name-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-shipping-last-name-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-shipping-last-name-operator").val()
            },
            _shipping_postcode: {
                value: $("#wobef-bulk-edit-form-order-shipping-postcode").val(),
                replace: $("#wobef-bulk-edit-form-order-shipping-postcode-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-shipping-postcode-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-shipping-postcode-operator").val()
            },
            _order_currency: {
                value: $("#wobef-bulk-edit-form-order-currency").val()
            },
            _cart_discount: {
                value: $("#wobef-bulk-edit-form-order-discount").val(),
                replace: $("#wobef-bulk-edit-form-order-discount-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-discount-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-discount-operator").val()
            },
            _cart_discount_tax: {
                value: $("#wobef-bulk-edit-form-order-discount-tax").val(),
                replace: $("#wobef-bulk-edit-form-order-discount-tax-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-discount-tax-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-discount-tax-operator").val()
            },
            _order_total: {
                value: $("#wobef-bulk-edit-form-order-total").val(),
                replace: $("#wobef-bulk-edit-form-order-total-replace").val(),
                sensitive: $("#wobef-bulk-edit-form-order-total-sensitive").val(),
                operator: $("#wobef-bulk-edit-form-order-total-operator").val()
            },
            _created_via: {
                value: $("#wobef-bulk-edit-form-order-create-via").val()
            },
            _payment_method: {
                value: $("#wobef-bulk-edit-form-order-payment-method").val()
            },
            _shipping_tax: {
                value: $("#wobef-bulk-edit-form-order-shipping-tax").val()
            },
            _order_tax: {
                value: $("#wobef-bulk-edit-form-order-tax").val()
            },
            _order_shipping: {
                value: $("#wobef-bulk-edit-form-order-shipping").val()
            },
            _recorded_coupon_usage_counts: {
                value: $("#wobef-bulk-edit-form-order-recorder-coupon-usage-counts").val()
            },
            _order_stock_reduced: {
                value: $("#wobef-bulk-edit-form-order-stock-reduced").val()
            },
            _prices_include_tax: {
                value: $("#wobef-bulk-edit-form-order-prices-index-tax").val()
            },
            _recorded_sales: {
                value: $("#wobef-bulk-edit-form-order-recorded-sales").val()
            },
        ...
        if (ordersChecked.length > 0) {
            ...
            wobefCloseModal();
            wobefOrdersBulkEdit(orderIDs, data, filterData);
        } else {
            swal({
                title: "Are you sure?",
                type: "warning",
            ...
            filterData = wobefGetCurrentFilterData();
        }
    });
    ...
    $(document).on('change', '#wobef-bulk-edit-change-status', function () {
        if ($(this).val()) {
            let orderIds = wobefGetCheckedItem();
            if (orderIds.length > 0) {
                wobefInlineEdit(orderIds, 'post_status', $(this).val(), true);
            }
        }
    });
    ...
    $(document).on('click', '.wobef-order-address-save-button', function () {
        wobefInlineEdit([$(this).attr('data-order-id')], $(this).attr('data-field'), $('textarea.wobef-modal-order-address-text').val(), true);
    });
